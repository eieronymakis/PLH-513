...
for(let i = 0; i < 12; i++){
    ...
    <div class="col-md-12 col-xl-10">
        ...
        <div class="row">
            ...
            <h3 class="fw-bold text-light">Product ${i}</h3>
            <div class="mt-1 mb-0 text-muted small">
                  <span class="h5 text-warning">Seller : John</span>
            </div>
            <div class="mt-1 mb-2 text-muted small">
                  <span class="h5 text-primary">Product Code : 213819831231902</span>
            </div>
            ...
            <div class="d-flex flex-row align-items-center mb-1">
                <h4 class="mb-1 me-1 text-light">$13.99</h4>
