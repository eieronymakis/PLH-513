            ...
            <div class="col-md-12 col-xl-10">
                ...
                <div class="row">
                    ...
                    <div class="d-flex flex-column mt-4">
                        <button class="btn btn-primary text-light  bg-success btn-lg mt-2" type="button" onclick="showModal(${data[i].id})">Modify</button>
                        <button class="btn btn-primary bg-danger text-light btn-lg mt-2" type="button">Delete</button>
                    </div>
                    </div>
                </div>
                </div>
...
function showModal(pid){
    ...
    // fetch(`http://127.0.0.1:3000/seller/product/${pid}/info`)
    // .then((response) => response.json())
    // .then((data) => {
